    ...
    <main className="min-h-screen pt-14 bg-background text-foreground">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          {/* CENTER: IMAGE */}
          <motion.div 
            className="lg:col-span-5 border-b lg:border-b-0 lg:border-r border-border"
            variants={fadeInUp}
          >
          ...
          {/* RIGHT: INTRO */}
          <motion.div 
            className="lg:col-span-5 p-8 lg:p-16 flex flex-col justify-center"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          >
            ...
            <div className="p-8 lg:p-16">
              ...
              <div className="flex flex-wrap gap-3">
                {config.exploring.map((tech, index) => (
                  <motion.span
                    key={tech}
